...
\usetikzlibrary{arrows,shapes,positioning,shadows,trees,calc,positioning}
...
\fancyhead[R]{
	\makebox[0.2\textwidth]{\raisebox{-1ex}{\hspace*{10ex}\includegraphics[width=0.1\textwidth]{Figures/FraUas_Logo.pdf}}}
}  % Kopfzeile rechts
...
\begin{document}
	...
	\input{TeXFiles/050_Datenerzeugung}
	\input{TeXFiles/060_Datenanalyse}
